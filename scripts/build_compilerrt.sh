...
function build_compilerrt ()
{
    ...
    PATH="${INSTALL_DIR}/bin/:$PATH" \
      ...
      cmake \
        -DCMAKE_C_FLAGS="  -target ${RISCV_GCC_TARGET} -B ${INSTALL_DIR}/lib/gcc/${RISCV_GCC_TARGET}/10.2.0 -O0 -g" \
        -DCMAKE_CXX_FLAGS="-target ${RISCV_GCC_TARGET} -B ${INSTALL_DIR}/lib/gcc/${RISCV_GCC_TARGET}/10.2.0 -O0 -g" \
